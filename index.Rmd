...
Before subsetting the data, it's important to remind that the singular linear regressions for this data produce a line of best fit that has the following form:
...
Political Ideology is a very volatile variable to assess. In fact, 
